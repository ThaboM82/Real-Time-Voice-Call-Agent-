        ...
        <div style={{ marginTop: "2rem" }}>
            ...
            <button
              ...
              onClick={() => {
                if (voiceChartRef.current) {
                  const url = voiceChartRef.current.toBase64Image();
                  const link = document.createElement("a");
                  link.href = url;
            ...
            <button
              ...
              onClick={() => {
                if (tagChartRef.current) {
                  const url = tagChartRef.current.toBase64Image();
                  const link = document.createElement("a");
                  link.href = url;
          ...
          <div style={{ maxWidth: "600px", marginBottom: "2rem" }}>
            ...
            <button
              style={{ marginTop: "0.5rem" }}
              onClick={() => {
                if (wordChartRef.current) {
                  const url = wordChartRef.current.toBase64Image();
                  const link = document.createElement("a");
                  link.href = url;
